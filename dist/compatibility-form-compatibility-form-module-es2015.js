    ...
    getAllCaste() {
        return new Promise((res, rej) => {
            this.http.get('https://partner.hansmatrimony.com/api/getAllCaste')
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["timeout"])(5000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["catchError"])(e => {
...
let CompatibilityPageTwoComponent = class CompatibilityPageTwoComponent {
    constructor(http, dialog, formBuilder, router, notification, fourPageService, ngxNotificationService, spinner, chatService) {
        ...
        fourPageService.seeProfilesBtnClicked.subscribe(status => {
            if (status) {
    ...
    ngOnInit() {
        ...
        this.PageTwo.get('Working').valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["debounceTime"])(400), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["takeUntil"])(this.onDestroy))
            .subscribe(() => {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], CompatibilityPageTwoComponent.prototype, "sharePageTwo", void 0);
