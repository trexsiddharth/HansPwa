    ...
    var SubscriptionComponent = /*#__PURE__*/function () {
      ...
      _createClass(SubscriptionComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.http.get("https://partner.hansmatrimony.com/api/getWebsitePlanById?id=".concat(localStorage.getItem('id'), "\n      &is_lead=").concat(localStorage.getItem('is_lead')), {
            headers: headers
            ...
            if (localStorage.getItem('showRemarrigePlan') && localStorage.getItem('showRemarrigePlan') === '1') {
              ...
              if (!localStorage.getItem('low income') && localStorage.getItem('low income') !== 'true') {
                ...
                for (var _i2 = 0; _i2 < _this.plans.length; _i2++) {
                  if (_this.plans[_i2].plan_name !== 'Re-Marriage' && _this.plans[_i2].plan_name !== 'Re-Marriage Deluxe') {
                    if (_this.plans[_i2].plan_type === 'Self Service Plan') {
                      if (_this.plans[_i2].plan_name === 'Basic' && _this.plans[_i2].category_name !== 'Normal' && _this.authData && _this.authData.gender === 'Male') {
                        _this.plansOnline.push(_this.plans[_i2]);
                      } else if (_this.plans[_i2].plan_name !== 'Basic' && _this.plans[_i2].category_name === 'Normal') {
                        _this.plansOnline.push(_this.plans[_i2]);
                      }
                    } else {
                      _this.plansPersonlised.push(_this.plans[_i2]);
                    }
                  }
                }
              }
