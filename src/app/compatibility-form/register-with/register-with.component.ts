...
selection;
  ...
  checkLoginState() {
    FB.getLoginStatus((response) => {
      ...
      // tslint:disable-next-line: max-line-length
      window.location.href = `https://www.facebook.com/v8.0/dialog/oauth?client_id=449447648971731&redirect_uri=https://www.facebook.com/connect/login_success.html`;
    });
  }
