...
@Component({
  selector: 'app-full-form-two',
  templateUrl: './full-form-two-component.html',
  styleUrls: ['./full-form-two-component.css']
})
export class FullFormTwoComponent implements OnInit, OnDestroy {
