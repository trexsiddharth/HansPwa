...
@Component({
  selector: 'app-full-page-five',
  templateUrl: './full-page-five.component.html',
  styleUrls: ['./full-page-five.component.css']
})

export class FullPageFiveComponent implements OnInit {
  ...
  onSubmitPersonal() {
    ...
    if (this.verifyForm.valid) {
      ...
      personalProfileDataForm.append('family_type', this.verifyForm.value.family_type);
      personalProfileDataForm.append('house_type', this.verifyForm.value.house_type);
      personalProfileDataForm.append('married_sons', this.verifyForm.value.brothers_married);
      personalProfileDataForm.append('unmarried_sons', this.verifyForm.value.brothers_unmarried);
      personalProfileDataForm.append('married_daughters', this.verifyForm.value.sisters_married);
      personalProfileDataForm.append('unmarried_daughters', this.verifyForm.value.sisters_unmarried);
      personalProfileDataForm.append('city', this.verifyForm.value.family_living_in);
      console.log(personalProfileDataForm);
      this.http
        .post(
          'https://partner.hansmatrimony.com/api/franchiseupdateFifthPageDetails',
