...
async ngAfterViewInit() {
  ...
  changeOfRoutes() {
     // tslint:disable-next-line: max-line-length
     if (location.href.indexOf('chat') > - 1 || location.href.indexOf('subscription') > - 1 || location.href.indexOf('register') > - 1 || location.href.indexOf('history') > - 1 || location.href.indexOf('myprofile') > - 1 ) { this.footer = false;
