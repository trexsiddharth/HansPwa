...
import { RUSureComponent } from './r-u-sure/r-u-sure.component';
...
export class SettingsComponent implements OnInit {
  ...
  openUserProfile() {
    this.router.navigateByUrl(`chat/my-profile-new/${localStorage.getItem('id')}/${localStorage.getItem('is_lead')}`);
  }
  openRUSureDialog() {
    ...
    const dialogRef = this.dialogRef.open(RUSureComponent, dialogConfig);
